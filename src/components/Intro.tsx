  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Download CV{" "}
          <HiDownload className="group-hover:translate-y-2 transition" />
        </a>
        <a
          href="https://github.com/SaiSawant1"
          className="border border-black/10 bg-white active:scale-105 hover:scale-[1.15] hover:text-gray-950 focus:scale-110 ease-in transition  outline-none text-gray-700 p-4  flex items-center justify-center rounded-full gap-2 dark:bg-white/10"
        >
          <BsGithub />
        </a>
      </motion.div>
